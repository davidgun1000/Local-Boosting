function theta = plot_posterior(ind,F_eta,F_mu,F_B,F_d,Transf,AKDE,varargin)
...
theta = VArand(10000,F_eta,F_mu,F_B,F_d,Transf);
...
for i = 1:length(ind)
    ...
    disp(['VASmithetal skewness = ' mat2str(skewness(theta(ind(i),:)))])
