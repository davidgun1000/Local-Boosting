...
%This code implements Global boosting for logistic regression model with
%mixture of T
...
for c=1:nrComponent
    ...
    cpu_time(c,1) = toc;
        ...
        [mix_Mu{c,1}(1:num_randeffect,1),init_T] = initialisation_global_update_used(num_randeffect,num_param,mix_Mu,mix_T,mix_Weights,indx,indx_diag,...
            c,prior,num_period,group,y,x,num_some); %initialisation mean and cholesky factor of latent variables. 
    ...
    mod_name=['mixCop_Global',num2str(c),'_',num2str(num_some),'_reparam_mixT_Bimodal.mat'];
    save(mod_name,'mix_Weights','mix_Mu','mix_T','mix_T_das','LB_est','mix_Weights_old','measure_latent','LB_smooth','mix_T_first','mix_T_second','MSE_latent','cpu_time','prior');
