...
%priors of random effects follow MixT distribution.
...
for i=1:s
    ...
    Post1.theta(i,:) = theta(1:100);
    Post2.theta(i,:) = theta(101:200);
    Post3.theta(i,:) = theta(201:300);
    Post4.theta(i,:) = theta(301:400);
    Post5.theta(i,:) = theta(400:end);
    
    if mod(i,1000)==0
       save('/scratch/hc87/dg2271/HMC_mixT_full1_Bimodal.mat','Post1','prior');
       save('/scratch/hc87/dg2271/HMC_mixT_full2_Bimodal.mat','Post2','prior');
       save('/scratch/hc87/dg2271/HMC_mixT_full3_Bimodal.mat','Post3','prior');
       save('/scratch/hc87/dg2271/HMC_mixT_full4_Bimodal.mat','Post4','prior');
       save('/scratch/hc87/dg2271/HMC_mixT_full5_Bimodal.mat','Post5','prior');
