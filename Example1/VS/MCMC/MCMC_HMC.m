...
for i=1:100
    ...
    if mod(i,1000)==0
       save('/scratch/hc87/dg2271/HMC_mixT_full1_VS.mat','Post1','prior');
       save('/scratch/hc87/dg2271/HMC_mixT_full2_VS.mat','Post2');
       save('/scratch/hc87/dg2271/HMC_mixT_full3_VS.mat','Post3');
       save('/scratch/hc87/dg2271/HMC_mixT_full4_VS.mat','Post4');
       save('/scratch/hc87/dg2271/HMC_mixT_full5_VS.mat','Post5');
