function theta = plot_posterior(ind,F_eta,F_mu,F_tkappa,F_l,Transf,AKDE,varargin)
...
theta = VArand(10000,F_eta,F_mu,F_tkappa,F_l,Transf);
...
for i = 1:length(ind)
    ...
    disp(['VAspheri skewness = ' mat2str(skewness(theta(ind(i),:)))])
