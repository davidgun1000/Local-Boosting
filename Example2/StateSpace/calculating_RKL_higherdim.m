function [variance] = calculating_RKL_higherdim(num_states,num_param,mix_Mu,mix_T,mix_Weights,prior,y,num_some,dim_states,x,indx_col)
    ...
    theta_G = theta(dim_states*num_states+num_param,1);
