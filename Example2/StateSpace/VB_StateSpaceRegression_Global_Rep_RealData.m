...
num_some= 50; %the number of latent states with complex prior distributions
...
for c=1:nrComponent
    ...
    mod_name=['mixCop_Global',num2str(c),'_',num2str(num_some),'_statespace_Z_regression_FF_RealData_Agric.mat'];
