...
parpool(10)
%parpool(4)
load('FamaFrenchData.mat'); %load the dataset
num_param=1;
dim_states=4;
y = FoodRF_stan;
x1 = MktRF_stan;
...
%         
        ...
        for j=1:length(id_mean_update_latent)
            ...
            if id_mean_update_latent(j) == 1
               ...
               mix_T{c,1}(indx_col.I(indx_col.par.Lii{id_mean_update_latent(j),1}(3)),indx_col.J(indx_col.par.Lii{id_mean_update_latent(j),1}(3)))=init_T(indx_col.I(indx_col.par.Lii{id_mean_update_latent(j),1}(3)),1); 
               mix_T_das{c,1}(indx_col.I(indx_col.par.Lii{id_mean_update_latent(j),1}(3)),indx_col.J(indx_col.par.Lii{id_mean_update_latent(j),1}(3))) = log(init_T(indx_col.I(indx_col.par.Lii{id_mean_update_latent(j),1}(3)),1));
               
               
               
               %mix_T{c,1}(indx_col.I(indx_col.par.Lii{id_mean_update_latent(j),1}(1)),indx_col.J(indx_col.par.Lii{id_mean_update_latent(j),1}(1)))=0.5; 
               %mix_T_das{c,1}(indx_col.I(indx_col.par.Lii{id_mean_update_latent(j),1}(1)),indx_col.J(indx_col.par.Lii{id_mean_update_latent(j),1}(1))) = log(init_T(indx_col.I(indx_col.par.Lii{id_mean_update_latent(j),1}(1)),1));
               ...
               %mix_T{c,1}(id_mean_update_latent(j)+1,id_mean_update_latent(j))=0.0000000001;
               %mix_T_das{c,1}(id_mean_update_latent(j)+1,id_mean_update_latent(j))=0.0000000001;
            end
            ...
            if id_mean_update_latent(j)>1 & id_mean_update_latent(j)<num_states
               ...
               mix_T_das{c,1}(indx_col.I(indx_col.par.Ltilde{id_mean_update_latent(j)-1,1}(3)),indx_col.J(indx_col.par.Ltilde{id_mean_update_latent(j)-1,1}(3)))=0;
               mix_T_das{c,1}(indx_col.I(indx_col.par.Ltilde{id_mean_update_latent(j)-1,1}(4)),indx_col.J(indx_col.par.Ltilde{id_mean_update_latent(j)-1,1}(4)))=0;
               %mix_T{c,1}(id_mean_update_latent(j),id_mean_update_latent(j)-1)=0.0000000001;
               %mix_T{c,1}(id_mean_update_latent(j)+1,id_mean_update_latent(j))=0.0000000001;
            
               %mix_T_das{c,1}(id_mean_update_latent(j),id_mean_update_latent(j)-1) = 0.0000000001;
               %mix_T_das{c,1}(id_mean_update_latent(j)+1,id_mean_update_latent(j))=0.0000000001;
            end
        ...
        % 
        % 
        %        mix_T{c,1}(indx_col.I(indx_col.par.Lii{id_mean_update_latent(j),1}(1)),indx_col.J(indx_col.par.Lii{id_mean_update_latent(j),1}(1)))=1; 
        %        mix_T_das{c,1}(indx_col.I(indx_col.par.Lii{id_mean_update_latent(j),1}(1)),indx_col.J(indx_col.par.Lii{id_mean_update_latent(j),1}(1))) = log(1);
        %        % 
        %        mix_T{c,1}(indx_col.I(indx_col.par.Lii{id_mean_update_latent(j),1}(3)),indx_col.J(indx_col.par.Lii{id_mean_update_latent(j),1}(3)))=1; 
        %        mix_T_das{c,1}(indx_col.I(indx_col.par.Lii{id_mean_update_latent(j),1}(3)),indx_col.J(indx_col.par.Lii{id_mean_update_latent(j),1}(3))) = log(1);
        % 
        % 
        % end
        ...
        %mix_T{c,1}(dim_states*num_states+1:dim_states*num_states+num_param,dim_states*num_states+1:dim_states*num_states+num_param) = (100*speye(num_param));
        %mix_T_das{c,1}(dim_states*num_states+1:dim_states*num_states+num_param,dim_states*num_states+1:dim_states*num_states+num_param) = log(100)*speye(num_param);
...
%             
    ...
    if c<nrComponent
       ...
       id_mean_update = [dim_states*id_mean_update_latent;dim_states*id_mean_update_latent-1];
       init_mu = [init_mu_latent;init_mu_G];
       
    end
     mix_Weights_old=mix_Weights;
     mod_name=['mixCop_Local',num2str(c),'_',num2str(num_some),'_statespace_sv_Z_regression_FF_RealData_Agri.mat'];
    save(mod_name,'mix_Weights','mix_Mu','mix_T','mix_T_das','LB_est','mix_Weights_old','id_mean_update_store','measure_latent','LB_smooth','prior','cpu_time');
